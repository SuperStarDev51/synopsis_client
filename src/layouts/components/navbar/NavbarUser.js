...
class NavbarUser extends React.PureComponent {
  ...
  render() {
    ...
    const userNameCapitalLetters = user && user.first_name && user.last_name ? user.first_name[0]+user.last_name[0] : ''
     ...
     */}
        <UncontrolledDropdown tag="li" className="dropdown-user nav-item">
          <DropdownToggle tag="a" className="nav-link dropdown-user-link">
            ...
            <span data-tour="user">
              <Avatar>{userNameCapitalLetters}</Avatar>
             {/* <img
