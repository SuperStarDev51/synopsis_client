...
// const jsConfig: webpack.Rule = {
// 	test: /\.js$/,
// 	exclude: /node_modules/,
// 	loader: 'babel-loader'
// }

const jsxConfig: webpack.Rule = {
	test: /\.(jsx|js)?$/,
	exclude: /node_modules/,
	use: [{
		loader: 'babel-loader',
...
module.exports = (env: Environment = {}): Configuration => {
	...
	return {
		...
		module: {
			rules: [tsConfig,jsxConfig,  htmlConfig, cssConfig, fontsConfig, svgConfig, svgCSSConfig, imagesConfig, mediaConfig]
		},
		resolve: {
			alias: {
				'@src': PATHS.src,
			...
			...(isDev
				...
				: [
						...
						new WebpackPwaManifest({
							...
							icons: [
								{
									src: resolve('src/assets/icons/icon-512x512.png'),
